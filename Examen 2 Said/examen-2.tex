...
%\begin{Repeat}{2}
  ...
  \begin{ejercicio}{1}
    Sea $R \subseteq  A \times A$ una relación no vacía. Prueba que si $\id_A \subseteq (A \times A) \setminus R$, entonces $R$ no puede ser transitiva y simétrica simultáneamente.
  \end{ejercicio}
