...
\begin{document}
    ...
    \begin{ejercicio}{1}
        Indica cuáles de las siguientes proposiciones son tautologías o contradicciones. Para aquellas que sean contingentes, da una equivalencia lógica que utilice únicamente los conectivos negación y disyunción.
        \begin{multicols}{3}
            \begin{enumerate}
    ...
    \begin{ejercicio}{1}
        ...
        \begin{enumerate}
            ...
            \item Concluye que $A \in \mathscr{P}(A \cap B)$ ocurre si y sólo si $A \cup B \in \mathscr{P}(B)$.
        \end{enumerate}
    \end{ejercicio}
