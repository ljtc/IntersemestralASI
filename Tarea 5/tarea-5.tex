...
\begin{document}
    ...
    \begin{ejercicio}{1}
        De dos ejemplos de funciones de $\mathbb{N}$ en $\mathbb{N}$; una que sea sobreyectiva, pero no inyectiva; y otra, que sea inyectiva, pero no sobreyectiva. Demuestra todas tus afirmaciones.
    \end{ejercicio}

    \begin{ejercicio}{2}
        Un natural $m$ es compuesto si existen naturales $a$ y $b$ tales que $1 < a < m$, $1 < b < m$ y $m = ab$, de lo contraro, decimos que $m$ es primo. Demuestra que todo natural $n \geq 2$ es producto de números primos.
